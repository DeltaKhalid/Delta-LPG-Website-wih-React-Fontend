...
// ✅ FIX: import images from src/assets so they work in production build
import aboutOneImg1 from "../assets/images/resources/about-one-img-1.jpg";
import aboutOneLine from "../assets/images/shapes/about-one-line.png";
import aboutOneSatisfiedShape1 from "../assets/images/shapes/about-one-satisfied-shape-1.png";
import fireIcon from "../assets/images/shapes/fire_icon.png";
import servicesShape1 from "../assets/images/shapes/services-one-shape-1.png";
import fireIcon40 from "../assets/images/shapes/fire_icon_40.png";

const Home = () => {
  const preloadedHomeProducts = getPreloadedApiData("homeProducts");
  const preloadedVideo = getPreloadedApiData("homePromotionalVideo");
  const preloadedSliderBelowSection = getPreloadedApiData("sliderBelowSection");
  const preloadedHomeAbout = getPreloadedApiData("homeAboutUs");
  const preloadedActiveProducts = getPreloadedApiData("activeProducts");
  const preloadCompleted = hasSitePreloadCompleted();

  /// ---------- Variables of Home Products API Call --------------------- ///
  const [homeProductsData, setHomeProductsData] = useState(preloadedHomeProducts ?? null);
  const [homeProductsDataLoading, setHomeProductsDatasetLoading] = useState(() => !preloadedHomeProducts && !preloadCompleted);

  /// ---------- Variables of Home page promotion video API Call --------- ///
  const [videoData, setVideoData] = useState(preloadedVideo ?? null);
  const [loading, setLoading] = useState(() => !preloadedVideo && !preloadCompleted);

  // ✅ FIX: you were using setError but it was commented out
  ...
  const [sliderBelowSectionData, setSliderBelowSectionDataData] = useState(preloadedSliderBelowSection ?? null);
  const [loadingOfSliderBelowSection, setLoadingOfSliderBelowSection] = useState(() => !preloadedSliderBelowSection && !preloadCompleted);

  /// ---------- Variables of Home About Us Content API Call ------------- ///
  const [homeAboutData, setHomeAboutData] = useState(preloadedHomeAbout ?? null);

  /// ------------------- Home Page Active Product list API Call ----------- //
  const [activeProducts, setActiveProducts] = useState(preloadedActiveProducts ?? []);

  useEffect(() => {
    if (preloadedActiveProducts) {
      setLoading(false);
      return;
    }
  ...
  useEffect(() => {
    if (preloadedHomeProducts) {
      setHomeProductsDatasetLoading(false);
      setLoading(false);
      return;
    }
  ...
  useEffect(() => {
    if (preloadedSliderBelowSection) {
      setLoadingOfSliderBelowSection(false);
      setLoading(false);
      return;
    }
  ...
  /// -------------------- Class for Fade Animation (single element) ------- ///
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
      ...
      <div className="">
                ...
                <div className="about-one__right">
                  <div className="section-title text-left">
                    <div className="section-sub-title-box ">
                      <p className="section-sub-title my-fadeIn-up-style" data-wow-delay="100ms">
                        About Delta LPG 888
                      </p>
                    ...
                    <div className={isVisible ? "fadeInUp " : ""} style={{ visibility: isVisible ? "visible" : "hidden" }}>
                      <h2 className="section-title__title wow fadeInUp" data-wow-delay="100ms">
                        {homeAboutData?.title_01}
                      </h2>
                    </div>
                  </div>

                  <p className={isVisible ? "fadeInUp " : ""} style={{ visibility: isVisible ? "visible" : "hidden" }}>
                  ...
                  <a
                    ...
                    className="thm-btn about-one__btn wow fadeInUp"
                    data-wow-delay="100ms"
                  >
                    {" "}
                    <i className="fa fa-arrow-right"></i> Discover more
                  </a>
                </div>
              </div>
            </div>
                ...
                <div className="col-xl-7 col-lg-6">
                  <div className="services-one__top-left">
                    <div className="section-title text-left">
                      ...
                      <h2 className="section-title__title_for_home my-fadeIn-up-style" data-wow-delay="100ms">
                        {homeProductsData?.headline}
                      </h2>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="services-one__single">
                    <div className="services-one__img">
                      {activeProducts.length > 0 && (
                        <img
                          src={Urls.buildMediaUrl(activeProducts[0].product_img)}
                    ...
                    <div className="services-one__content">
                      <div className="services-one__icon_design_2">
                        <img src={fireIcon40} alt="" />
                      </div>

                      <h3 className="services-one__title">
                        <a href="single-play-roofing.html">{activeProducts[0]?.product_name}</a>
                      </h3>
                  ...
                  <div className="services-one__single">
                    <div className="services-one__img">
                      {activeProducts.length > 1 && (
                        <img
                          src={Urls.buildMediaUrl(activeProducts[1].product_img)}
                    ...
                    <div className="services-one__content">
                      ...
                      <h3 className="services-one__title">
                        <a href="single-play-roofing.html">{activeProducts[1]?.product_name}</a>
                      </h3>
                  ...
                  <div className="services-one__single">
                    <div className="services-one__img">
                      {activeProducts.length > 2 && (
                        <img
                          src={Urls.buildMediaUrl(activeProducts[2].product_img)}
                    ...
                    <div className="services-one__content">
                      ...
                      <h3 className="services-one__title">
                        <a href="single-play-roofing.html">{activeProducts[2]?.product_name}</a>
                      </h3>
        ...
        <section className="trust-company ">
          ...
          <div
            ...
            // NOTE: "assets/..." means public/assets. Keep it if that's where the file is.
            style={{ backgroundImage: "url(assets/images/backgrounds/trust-company-bg.jpg)" }}
          />
        ...
        {/* If you want Header/Footer, uncomment */}
        {/* <Header /> */}
        {/* <Footer /> */}
      </div>
    </div>
