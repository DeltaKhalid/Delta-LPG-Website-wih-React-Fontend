...
// ✅ Import images instead of using "src/assets/..." strings
...
import missionVisionImg from '../../assets/images/resources/mission_vision.png';
        ...
        <div className="page-wrapper">
            ...
            <div className="container">
              <div className="page-header__inner">
                <ul className="thm-breadcrumb list-unstyled">
                  {/* If you're using react-router, replace <a> with <Link> */}
          ...
          <section className="mission_vision_headline">
            <div className="about-one__shape float-bob-x">
              <img src={aboutOneShape} alt="Decor shape" />
            </div>
                  ...
                  <div className="about-one__left">
                    ...
                    >
                      ...
                      <div className="about-one__line">
                        <img src={aboutOneLine} alt="Line shape" />
                      </div>
