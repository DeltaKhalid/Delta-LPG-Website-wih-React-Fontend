...
// ✅ Import images instead of using "src/assets/..." directly
...
import bulkServiceImg01 from "../../assets/images/resources/bulk_service_img_01.png";
              ...
              <div className="services-one__single">
                <div className="services-one__content">
                  <h3 className="services-one__title">
                    <a href="modified-roofing.html"></a>
                  </h3>

                  {/* ✅ Use imported image */}
                  <img
                    className="centered-image"
                    src={bulkServiceImg01}
                    alt="Bulk service"
                  />
            ...
            >
              <div className="services-one__single">
                <div className="services-one__content">
                  ...
                  <p className="services-one__text">{bulkData.description}</p>
...
//                   <img
//                     className="centered-image"
//                     src="src/assets/images/resources/bulk_service_img_01.png"
//                     alt=""
//                   />
//                   {/* 50 px Empty Div */}
//                   <div className="empty_div"></div>
