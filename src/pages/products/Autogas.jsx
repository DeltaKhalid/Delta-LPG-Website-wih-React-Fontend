...
// ✅ Import images so bundler can resolve them correctly
...
import autoGasImg from "../../assets/images/resources/delta_auto_gas_06.jpg";
            ...
            <div className="col-xl-12 col-lg-12 wow fadeInUp" data-wow-delay="200ms">
              <div className="services-one__single">
                <div className="services-one__content">
                  ...
                  <img className="centered-image" src={autoGasImg} alt="Auto Gas" />

                  <div className="services-one__read-more">{/* empty */}</div>
                </div>
              </div>
            </div>
              ...
              <div className="services-one__single">
                <div className="services-one__content">
                  <p className="services-one__text">
                    Auto Gas: The Premier Alternative Fuel for Cars Auto Gas is rapidly emerging
                    as the leading alternative fuel to petrol for automobiles. Across the globe,
                    many developed nations are transitioning their vehicles from gasoline to
                    Auto Gas. Here are the key reasons driving this shift:
                  </p>

                  <h3 className="auto_gas_page_title_two">
                    <a href="#">1. Environmental Benefits :</a>
                  </h3>
                  <p className="auto_gas_page_body_text">
                    Auto Gas produces fewer emissions compared to traditional gasoline, helping
                    to reduce air pollution and combat climate change.
                  </p>

                  <h3 className="auto_gas_page_title_two">
                    <a href="#">2. Cost Efficiency :</a>
                  </h3>
                  <p className="auto_gas_page_body_text">
                    Auto Gas is often more affordable than petrol, offering significant savings
                    for drivers and reducing overall transportation costs.
                  </p>

                  <h3 className="auto_gas_page_title_two">
                    <a href="#">3. Engine Longevity :</a>
                  </h3>
                  <p className="auto_gas_page_body_text">
                    Vehicles running on Auto Gas typically experience less wear and tear, which
                    can result in longer engine life and lower maintenance expenses.
                  </p>

                  <h3 className="auto_gas_page_title_two">
                    <a href="#">4. Energy Security :</a>
                  </h3>
                  <p className="auto_gas_page_body_text">
                    By diversifying fuel sources, countries can enhance their energy security
