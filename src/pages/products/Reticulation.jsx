...
// ✅ FIX: import images so they work in production build (Vite)
...
import reticulationImg01 from "../../assets/images/resources/reticulation_img_01.png";
import reticulationImg05 from "../../assets/images/resources/reticulation_img_05.png";
...
const Reticulation = () => {
  ...
  return (
    <div>
              ...
              <div className="about-one__left">
                ...
                >
                  ...
                  <div className="about-one__satisfied">
                    <div className="about-one__satisfied-inner"></div>
                  </div>
            ...
            <div className="col-xl-6 col-md-12">
              <div className="about-one__right">
                ...
                <p>
                  ...
                  <br />
                  → 100% safe LPG supplied at optimum pressure to kitchen/end user’s
                  point.
                  <br />
      ...
      {/* Headline 02 */}
      <div className="mission_vision_headline_padding reticulation-mobile-hide-image-05">
        <div className="container">
          <div className="section-title text-center">
            <div className="section-sub-title-box">
              <h1 className="section-sub-title wow fadeInUp" data-wow-delay="100ms">
                {reticulationData.section_headline_02}
              </h1>
              <div className="section-title-shape-1">
                <img src={fireIcon} alt="" />
              </div>
      ...
      {/* // ================================================ section 2 ======================== // */}
      <section className="distribution_headline reticulation-mobile-hide-image-05">
        <div className="container">
          <div className="row">
            {/* Text Left */}
