...
// Images (IMPORTANT: adjust filenames if yours differ)
...
import product12kg from '../../assets/images/services/product_12_kg.jpg';
import product35kg from '../../assets/images/services/product_35_kg.jpg';
import product45kg from '../../assets/images/services/product_45_kg.jpg';
                ...
                <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                  <div className="services-one__single">
                    <div className="services-one__img">
                      <img src={product12kg} alt="12 kg LP Gas Cylinder" />
                    </div>
                ...
                <div className="col-xl-8 col-lg-8 wow fadeInUp" data-wow-delay="200ms">
                  <div className="services-one__single">
                    <div className="services-one__content">
                      ...
                      <p className="services-one__text">
                        {cylinderData.cylinder_2_description}
                      </p>
                      <div className="services-one__read-more" />
                    </div>
                  </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                  <div className="services-one__single">
                    <div className="services-one__img">
                      <img src={product45kg} alt="45 kg LP Gas Cylinder" />
                    </div>
                    <div className="services-one__content">
                      <div className="services-one__icon_design_2">
                        <img src={fireIcon40} alt="" />
                ...
                <div className="col-xl-8 col-lg-8 wow fadeInUp" data-wow-delay="200ms">
                  <div className="services-one__single">
                    <div className="services-one__content">
                      <h3 className="services-one__title">{cylinderData.cylinder_3_name}</h3>
                      <p className="services-one__text">
