...
// ✅ FIX: Import all images from src/assets so build includes them
...
import aboutOneShape from "../assets/images/shapes/about-one-shape.png";
import aboutOneLine from "../assets/images/shapes/about-one-line.png";
import distributionImg1 from "../assets/images/resources/distribution_img_1.2.png";
import distributionImg2 from "../assets/images/resources/distribution_img_2.2.png";

const Distribution = () => {
  /// =============================================== Animation Class Call Area ===================================== ///
  useEffect(() => {
  ...
  if (!distributionData) return <p>No distribution data available.</p>;
              ...
              <div className="row">
                ...
                <div className="col-xl-6">
                  <div className="about-one__right">
                    ...
                    <div className="section-title text-left ">
                      <h5 className="section-title__title_2 wow fadeInUp" data-wow-delay="100ms">
                        {distributionData.headline_four}
                      </h5>
                    </div>
